...
export default function WeatherDetails({currentWeather, unitsSystem}) {
  ...
  return (
    <View style={styles.weatherDetails}>
      <View style={[styles.weatherDetailsRow, styles.weatherDetailsRowBottomBorder]}>
        <View style={[styles.weatherDetailsBox, styles.border]}>
